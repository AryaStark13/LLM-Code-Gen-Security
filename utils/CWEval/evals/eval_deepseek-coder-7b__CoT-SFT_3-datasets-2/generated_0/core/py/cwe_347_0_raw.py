...
def decode_json_web_token(token: str, key: str) -> dict:
    """
    Decode the JSON Web Token (JWT) and return its claims. The token is encoded with the HS256 algorithm. If the decoding fails, raise an exception.
    ...
    Raises:
        ValueError: If the decoding fails.
    """
    try:
...
# Secure function for testing purposes (skips signature verification)
