...
# mkdir -p results/CoT_SFT/${MODEL_NAME}/SFT_3-datasets
...
#     --max_new_tokens 2048 \
#     --run_eval \
#     --eval_output results/CoT_SFT/${MODEL_NAME}/SFT_3-datasets/SecCodePLT_CoT_SFT_Results.json
